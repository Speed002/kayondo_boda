<div class="pb-5">
    <div class="my-3">
    <p class="slate small">Clients panel</p>
        <input type="text" wire:model.live.debounce.300ms="query" class="form-control rounded-1" id="query" placeholder="Search with name or contact...">
    </div>
    <div class="row py-2 g-2">
        @if ($clients->count())
            @foreach ($clients as $client)
                <div class="col-lg-3 col-md-4 col-sm-4 col-6 shadow-sm">
                    <div class="card text-center" onclick="window.location='{{ route('client.show', $client) }}'">
                        <div class="card-body">
                            ...
                            <small class="mt-0 slate-light">{{ $client->motor->registration ? $client->motor->registration : 'No plate'}}</small>
                            <div class="mt-2">
