    ...
    <div class="col-sm-8">
        ...
        <form wire:submit.prevent='submit'>
            <div class="mb-3 row g-3">
                <div class="col-md-4 ">
                <label for="exampleFormControlInput1" class="form-label">Initial deposit</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label">Weekly deposit</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label">Agreed months</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label">Total weeks</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label">Date of starting week</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label">Place of agreement</label>
