<div class="row py-4 mb-3">
    ...
    <p class="slate-light">Personal information</p>
        <form wire:submit.prevent='submit'>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">NIN Number</label>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Date of birth</label>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Contact</label>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Occupation</label>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Residence</label>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Stage name</label>
            ...
            <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Date of agreement</label>
            ...
            <div class="mb-3 row g-3">
                <div class="col-md-4 ">
                <label for="exampleFormControlInput1" class="form-label slate-light">Father's name</label>
                ...
                <div class="col-md-4 ">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Father's contact</label>
            ...
            <div class="mb-3 row g-3">
                <div class="col-md-4 ">
                <label for="exampleFormControlInput1" class="form-label slate-light">Mother's name</label>
                ...
                <div class="col-md-4 ">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Mother's contact</label>
