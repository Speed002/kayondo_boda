    ...
    <div class="col-sm-8">
        ...
        <form wire:submit.prevent='submit'>
            <div class="mb-3 row g-3">
                <div class="col-md-4 ">
                <label for="exampleFormControlInput1" class="form-label slate-light">Referee 1 name</label>
                ...
                <div class="col-md-4">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Referee 1 relationship</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Referee 1 contact</label>
                ...
                <div class="mb-3 row g-3">
                    <div class="col-md-4 ">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Referee 2 name</label>
                ...
                <div class="col-md-4">
                        <label for="exampleFormControlInput1" class="form-label slate-light">Referee 2 relationship</label>
                ...
                <div class="col-md-4">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Referee 2 contact</label>
                ...
                <div class="col-md-4">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Stage chairperson name</label>
                ...
                <div class="col-md-4">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Stage chairperson contact</label>
                ...
                <div class="col-md-4">
                    <label for="exampleFormControlInput1" class="form-label slate-light">Lc chairperson name</label>
                ...
                <div class="col-md-4">
                <label for="exampleFormControlInput1" class="form-label slate-light">Lc chairperson contact</label>
