<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Referee Information</li>
        </ol>
    </nav>
            ...
            @foreach ($editing as $field => $isEditing)
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        ...
                        <span class="slate-light">{{ $client->referee->$field }}</span>
                        @if ($isEditing)
    ...
    @else
        <p class="text-muted">No referee information available for this client.</p>
    @endif
    <script>
